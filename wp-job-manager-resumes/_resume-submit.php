...
?>
<form action="<?php //echo $action; ?> https://bantal.com.br/assinatura" method="post" id="submit-resume-form" class="job-manager-form" enctype="multipart/form-data">
	...
	<?php if ( resume_manager_user_can_post_resume() ) : ?>
		...
		<p>
			...
			<input type="submit" name="submit_resume" class="button" id="enviar-curriculo" value="Publicar Currículo"/>
			<!--<input type="submit" name="submit_resume" class="button" id="enviar-curriculo" value=" esc_attr_e( $submit_button_text ); ?>" />-->
