...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<?php if ( $categories ) : ?>
			...
			<?php endforeach; ?>
		<?php elseif ( $show_categories && ! is_tax( 'rea_de_atuao2' ) && get_terms( array( 'taxonomy' => 'rea_de_atuao2' ) ) ) : ?>
			<div class="search_categories">
				<label for="search_categories"><?php esc_html_e( 'Category', 'wp-job-manager' ); ?></label>
				<?php if ( $show_category_multiselect ) : ?>
					<?php job_manager_dropdown_categories( array( 'taxonomy' => 'rea_de_atuao2', 'hierarchical' => 1, 'name' => 'search_categories', 'orderby' => 'name', 'selected' => $selected_category, 'hide_empty' => true ) ); ?>
				<?php else : ?>
					<?php job_manager_dropdown_categories( array( 'taxonomy' => 'rea_de_atuao2', 'hierarchical' => 1, 'show_option_all' => __( 'Any category', 'wp-job-manager' ), 'name' => 'search_categories', 'orderby' => 'name', 'selected' => $selected_category, 'multiple' => false, 'hide_empty' => true ) ); ?>
				<?php endif; ?>
			</div>
		<?php endif; ?>
		...
		?>
			<div class="search_submit">
				<input type="submit" value="<?php esc_attr_e( 'Pesquisar', 'wp-job-manager' ); ?>">
			</div>
		<?php endif; ?>
